...
3. You open a [RFC issue](https://github.com/jasonFerre/python-lib/issues/new?assignees=&labels=RFC%2C+triage&template=rfc.md&title=RFC%3A+) to discuss any significant work - we would hate for your time to be wasted.
...
2. Install dependencies in a virtual env with poetry, and pre-commit hooks: `make install`
...
5. Send us a pull request with a [conventional semantic title](https://github.com/jasonFerre/python-lib/pull/67), and answering any default questions in the pull request interface.
